...
$_['text_sent']            = 'Ваше сообщение успешно отправлено %s из %s получателей!';
...
$_['entry_customer']       	= 'Покупатель:<br /><span class="help">Автодополнение</span>';
$_['entry_affiliate']      	= 'Партнёр:<br /><span class="help">Автодополнение</span>';
$_['entry_product']        	= 'Товары:<br /><span class="help">Отправить покупателям, которые уже заказали товары из списка. (Автодополнение)</span>';
